...
DocumentReference get currentUserReference => currentUser?.user != null
    ? ProfilePicRecord.collection.doc(currentUser.user.uid)
    : null;

ProfilePicRecord currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : ProfilePicRecord.getDocument(ProfilePicRecord.collection.doc(uid))
              .handleError((_) {}),
    )
